...
import com.zibi.broker.fragment.setting.R
...
interface OneFragmentMainViewModel {
...
class SettingViewModelImpl constructor(
  ...
  OneFragmentMainViewModel, Navigation {
  ...
  get() = { SettingData(
      ...
      descAppUserName = stringResolver.getString(R.string.fragment_setting_desc_user_name),
      descAppPassword = stringResolver.getString(R.string.fragment_setting_desc_password),
      descBrokerUserName = stringResolver.getString(R.string.fragment_setting_desc_user_name),
      descBrokerPassword = stringResolver.getString(R.string.fragment_setting_desc_password),
      ...
      onBack = { paramApp, paramBroker ->
          super.dispatch(action = Action.GoToBack(paramApp, paramBroker))},
      )
  }
