...
object Util {
  ...
  init {
    dateFormat = SimpleDateFormat(com.zibi.app.ex.client.view.Constants.DATE_FORMAT)
    dateTimeFormat = SimpleDateFormat(com.zibi.app.ex.client.view.Constants.DATE_TIME_FORMAT)
    dateTimeFormatWithoutSeconds = SimpleDateFormat(com.zibi.app.ex.client.view.Constants.DATE_TIME_FORMAT_WITHOUT_SECONDS)
  }
...
//      webViewDatabase.clearUsernamePassword()
  ...
  fun clearSharedPreferences(context: Context) {
    val settings = context.getSharedPreferences(
      com.zibi.app.ex.client.view.Constants.SHARED_PREFERENCES_NAME,
      0
    )
    ...
    val settings2 = context.getSharedPreferences(
      com.zibi.app.ex.client.view.Constants.SHARED_PREF_BLUE_BORN_WARN,
      0
    )
  ...
  fun getStringFromSharedPreferences(
    ...
    return sharedPreferences.getString(
      key,
      com.zibi.app.ex.client.view.Constants.SHARED_PREFERENCES_STRING_DEFAULT_VALUE
    )
  }
